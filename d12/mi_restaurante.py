...
# Variable global que se muestra en el visor de la calculadora
operador = ''
...
# Funciones vinculadas a los botones de la calculadora
...
# Funciones asociadas a los checkbuttons
...
def total():
    ...
    costo_total = sub_total + impuestos
    ...
    var_total.set(f'${round(costo_total, 2)}')
...
# Asociación de funciones a botones
...
# Asignación de funciones a los botones de la calculadora
